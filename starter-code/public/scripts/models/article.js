...
(function(module) {
  ...
  // It is invoked in every method in articleController.js. It makes a call to the database via the field and val arguments passed in from the function invoking it. It then calls the callback function that is taken as an argument.
  ...
  // This is not invoked anywhere. It interacts by calling other Article methods. The output of this code would be put into the console, as an Object, with properties derived from the methods it calls.
  Article.stats = () => {
    return {
  ...
  // This code interacts with the .put method in the server.js
